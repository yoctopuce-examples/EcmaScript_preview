...
export class YDataLogger extends YFunction
{
     ...
     */
    static FindDataLogger(func, obj_yapi = YAPI)
    {
        /** @type {YDataLogger} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'DataLogger', func);
        if (obj == null) {
            obj = new YDataLogger(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'DataLogger',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YDataLogger} a YDataLogger object allowing you to drive the data logger.
     */
    static FindDataLoggerInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YDataLogger} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'DataLogger', func);
        if (obj == null) {
            obj = new YDataLogger(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'DataLogger',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextDataLogger()
    {
        ...
        return YDataLogger.FindDataLogger(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstDataLogger(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('DataLogger');
        if(next_hwid == null) return null;
        return YDataLogger.FindDataLogger(next_hwid, obj_yapi);
    }
