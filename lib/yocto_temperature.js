...
export class YTemperature extends YSensor
{
     ...
     */
    static FindTemperature(func, obj_yapi = YAPI)
    {
        /** @type {YTemperature} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Temperature', func);
        if (obj == null) {
            obj = new YTemperature(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Temperature',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YTemperature} a YTemperature object allowing you to drive the temperature sensor.
     */
    static FindTemperatureInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YTemperature} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Temperature', func);
        if (obj == null) {
            obj = new YTemperature(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Temperature',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextTemperature()
    {
        ...
        return YTemperature.FindTemperature(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstTemperature(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Temperature');
        if(next_hwid == null) return null;
        return YTemperature.FindTemperature(next_hwid, obj_yapi);
    }
