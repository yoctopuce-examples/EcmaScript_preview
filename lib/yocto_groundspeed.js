...
export class YGroundSpeed extends YSensor
{
     ...
     */
    static FindGroundSpeed(func, obj_yapi = YAPI)
    {
        /** @type {YGroundSpeed} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'GroundSpeed', func);
        if (obj == null) {
            obj = new YGroundSpeed(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'GroundSpeed',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YGroundSpeed} a YGroundSpeed object allowing you to drive the ground speed sensor.
     */
    static FindGroundSpeedInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YGroundSpeed} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'GroundSpeed', func);
        if (obj == null) {
            obj = new YGroundSpeed(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'GroundSpeed',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextGroundSpeed()
    {
        ...
        return YGroundSpeed.FindGroundSpeed(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstGroundSpeed(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('GroundSpeed');
        if(next_hwid == null) return null;
        return YGroundSpeed.FindGroundSpeed(next_hwid, obj_yapi);
    }
