...
export class YWakeUpMonitor extends YFunction
{
     ...
     */
    static FindWakeUpMonitor(func, obj_yapi = YAPI)
    {
        /** @type {YWakeUpMonitor} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'WakeUpMonitor', func);
        if (obj == null) {
            obj = new YWakeUpMonitor(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'WakeUpMonitor',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YWakeUpMonitor} a YWakeUpMonitor object allowing you to drive the monitor.
     */
    static FindWakeUpMonitorInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YWakeUpMonitor} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'WakeUpMonitor', func);
        if (obj == null) {
            obj = new YWakeUpMonitor(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'WakeUpMonitor',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextWakeUpMonitor()
    {
        ...
        return YWakeUpMonitor.FindWakeUpMonitor(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstWakeUpMonitor(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('WakeUpMonitor');
        if(next_hwid == null) return null;
        return YWakeUpMonitor.FindWakeUpMonitor(next_hwid, obj_yapi);
    }
