...
export class YDigitalIO extends YFunction
{
     ...
     */
    static FindDigitalIO(func, obj_yapi = YAPI)
    {
        /** @type {YDigitalIO} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'DigitalIO', func);
        if (obj == null) {
            obj = new YDigitalIO(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'DigitalIO',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YDigitalIO} a YDigitalIO object allowing you to drive the digital IO port.
     */
    static FindDigitalIOInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YDigitalIO} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'DigitalIO', func);
        if (obj == null) {
            obj = new YDigitalIO(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'DigitalIO',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextDigitalIO()
    {
        ...
        return YDigitalIO.FindDigitalIO(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstDigitalIO(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('DigitalIO');
        if(next_hwid == null) return null;
        return YDigitalIO.FindDigitalIO(next_hwid, obj_yapi);
    }
