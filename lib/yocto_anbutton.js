...
export class YAnButton extends YFunction
{
     ...
     */
    static FindAnButton(func, obj_yapi = YAPI)
    {
        /** @type {YAnButton} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'AnButton', func);
        if (obj == null) {
            obj = new YAnButton(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'AnButton',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YAnButton} a YAnButton object allowing you to drive the analog input.
     */
    static FindAnButtonInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YAnButton} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'AnButton', func);
        if (obj == null) {
            obj = new YAnButton(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'AnButton',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextAnButton()
    {
        ...
        return YAnButton.FindAnButton(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstAnButton(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('AnButton');
        if(next_hwid == null) return null;
        return YAnButton.FindAnButton(next_hwid, obj_yapi);
    }
