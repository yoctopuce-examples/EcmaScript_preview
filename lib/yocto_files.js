...
export class YFiles extends YFunction
{
     ...
     */
    static FindFiles(func, obj_yapi = YAPI)
    {
        /** @type {YFiles} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Files', func);
        if (obj == null) {
            obj = new YFiles(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Files',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YFiles} a YFiles object allowing you to drive the filesystem.
     */
    static FindFilesInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YFiles} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Files', func);
        if (obj == null) {
            obj = new YFiles(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Files',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextFiles()
    {
        ...
        return YFiles.FindFiles(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstFiles(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Files');
        if(next_hwid == null) return null;
        return YFiles.FindFiles(next_hwid, obj_yapi);
    }
