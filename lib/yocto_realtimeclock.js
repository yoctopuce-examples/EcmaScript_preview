...
export class YRealTimeClock extends YFunction
{
     ...
     */
    static FindRealTimeClock(func, obj_yapi = YAPI)
    {
        /** @type {YRealTimeClock} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'RealTimeClock', func);
        if (obj == null) {
            obj = new YRealTimeClock(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'RealTimeClock',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YRealTimeClock} a YRealTimeClock object allowing you to drive the clock.
     */
    static FindRealTimeClockInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YRealTimeClock} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'RealTimeClock', func);
        if (obj == null) {
            obj = new YRealTimeClock(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'RealTimeClock',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextRealTimeClock()
    {
        ...
        return YRealTimeClock.FindRealTimeClock(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstRealTimeClock(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('RealTimeClock');
        if(next_hwid == null) return null;
        return YRealTimeClock.FindRealTimeClock(next_hwid, obj_yapi);
    }
