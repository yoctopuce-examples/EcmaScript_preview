...
export class YPower extends YSensor
{
     ...
     */
    static FindPower(func, obj_yapi = YAPI)
    {
        /** @type {YPower} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Power', func);
        if (obj == null) {
            obj = new YPower(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Power',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YPower} a YPower object allowing you to drive the electrical power sensor.
     */
    static FindPowerInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YPower} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Power', func);
        if (obj == null) {
            obj = new YPower(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Power',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextPower()
    {
        ...
        return YPower.FindPower(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstPower(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Power');
        if(next_hwid == null) return null;
        return YPower.FindPower(next_hwid, obj_yapi);
    }
