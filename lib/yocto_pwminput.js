...
export class YPwmInput extends YSensor
{
     ...
     */
    static FindPwmInput(func, obj_yapi = YAPI)
    {
        /** @type {YPwmInput} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'PwmInput', func);
        if (obj == null) {
            obj = new YPwmInput(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'PwmInput',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YPwmInput} a YPwmInput object allowing you to drive the PWM input.
     */
    static FindPwmInputInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YPwmInput} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'PwmInput', func);
        if (obj == null) {
            obj = new YPwmInput(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'PwmInput',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextPwmInput()
    {
        ...
        return YPwmInput.FindPwmInput(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstPwmInput(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('PwmInput');
        if(next_hwid == null) return null;
        return YPwmInput.FindPwmInput(next_hwid, obj_yapi);
    }
