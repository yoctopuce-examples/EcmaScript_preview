...
export const Y_LINKSTATE_DOWN                = 0;
export const Y_LINKSTATE_FREE                = 1;
export const Y_LINKSTATE_SEARCH              = 2;
export const Y_LINKSTATE_EXISTS              = 3;
export const Y_LINKSTATE_LINKED              = 4;
export const Y_LINKSTATE_PLAY                = 5;
export const Y_LINKSTATE_INVALID             = -1;
export const Y_OWNADDRESS_INVALID            = YAPI.INVALID_STRING;
export const Y_PAIRINGPIN_INVALID            = YAPI.INVALID_STRING;
export const Y_REMOTEADDRESS_INVALID         = YAPI.INVALID_STRING;
export const Y_REMOTENAME_INVALID            = YAPI.INVALID_STRING;
export const Y_PREAMPLIFIER_INVALID          = YAPI.INVALID_UINT;
...
export class YBluetoothLink extends YFunction
{
     ...
     */
    static FindBluetoothLink(func, obj_yapi = YAPI)
    {
        /** @type {YBluetoothLink} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'BluetoothLink', func);
        if (obj == null) {
            obj = new YBluetoothLink(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'BluetoothLink',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YBluetoothLink} a YBluetoothLink object allowing you to drive the cellular interface.
     */
    static FindBluetoothLinkInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YBluetoothLink} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'BluetoothLink', func);
        if (obj == null) {
            obj = new YBluetoothLink(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'BluetoothLink',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextBluetoothLink()
    {
        ...
        return YBluetoothLink.FindBluetoothLink(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstBluetoothLink(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('BluetoothLink');
        if(next_hwid == null) return null;
        return YBluetoothLink.FindBluetoothLink(next_hwid, obj_yapi);
    }
 ...
 */
export function yFindBluetoothLink(func)
{
 ...
 * comment from .yc definition
 */
export function yFirstBluetoothLink()
{
