...
export class YNetwork extends YFunction
{
     ...
     */
    static FindNetwork(func, obj_yapi = YAPI)
    {
        /** @type {YNetwork} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Network', func);
        if (obj == null) {
            obj = new YNetwork(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Network',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YNetwork} a YNetwork object allowing you to drive the network interface.
     */
    static FindNetworkInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YNetwork} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Network', func);
        if (obj == null) {
            obj = new YNetwork(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Network',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextNetwork()
    {
        ...
        return YNetwork.FindNetwork(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstNetwork(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Network');
        if(next_hwid == null) return null;
        return YNetwork.FindNetwork(next_hwid, obj_yapi);
    }
