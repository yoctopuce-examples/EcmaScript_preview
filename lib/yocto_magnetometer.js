...
export class YMagnetometer extends YSensor
{
     ...
     */
    static FindMagnetometer(func, obj_yapi = YAPI)
    {
        /** @type {YMagnetometer} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Magnetometer', func);
        if (obj == null) {
            obj = new YMagnetometer(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Magnetometer',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YMagnetometer} a YMagnetometer object allowing you to drive the magnetometer.
     */
    static FindMagnetometerInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YMagnetometer} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Magnetometer', func);
        if (obj == null) {
            obj = new YMagnetometer(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Magnetometer',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextMagnetometer()
    {
        ...
        return YMagnetometer.FindMagnetometer(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstMagnetometer(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Magnetometer');
        if(next_hwid == null) return null;
        return YMagnetometer.FindMagnetometer(next_hwid, obj_yapi);
    }
