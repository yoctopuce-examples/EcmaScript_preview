...
export class YGenericSensor extends YSensor
{
     ...
     */
    static FindGenericSensor(func, obj_yapi = YAPI)
    {
        /** @type {YGenericSensor} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'GenericSensor', func);
        if (obj == null) {
            obj = new YGenericSensor(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'GenericSensor',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YGenericSensor} a YGenericSensor object allowing you to drive the generic sensor.
     */
    static FindGenericSensorInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YGenericSensor} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'GenericSensor', func);
        if (obj == null) {
            obj = new YGenericSensor(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'GenericSensor',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextGenericSensor()
    {
        ...
        return YGenericSensor.FindGenericSensor(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstGenericSensor(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('GenericSensor');
        if(next_hwid == null) return null;
        return YGenericSensor.FindGenericSensor(next_hwid, obj_yapi);
    }
