...
export class YGps extends YFunction
{
     ...
     */
    static FindGps(func, obj_yapi = YAPI)
    {
        /** @type {YGps} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Gps', func);
        if (obj == null) {
            obj = new YGps(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Gps',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YGps} a YGps object allowing you to drive the GPS.
     */
    static FindGpsInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YGps} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Gps', func);
        if (obj == null) {
            obj = new YGps(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Gps',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextGps()
    {
        ...
        return YGps.FindGps(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstGps(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Gps');
        if(next_hwid == null) return null;
        return YGps.FindGps(next_hwid, obj_yapi);
    }
