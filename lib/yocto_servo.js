...
export class YServo extends YFunction
{
     ...
     */
    static FindServo(func, obj_yapi = YAPI)
    {
        /** @type {YServo} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Servo', func);
        if (obj == null) {
            obj = new YServo(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Servo',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YServo} a YServo object allowing you to drive the servo.
     */
    static FindServoInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YServo} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Servo', func);
        if (obj == null) {
            obj = new YServo(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Servo',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextServo()
    {
        ...
        return YServo.FindServo(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstServo(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Servo');
        if(next_hwid == null) return null;
        return YServo.FindServo(next_hwid, obj_yapi);
    }
