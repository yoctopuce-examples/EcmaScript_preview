...
export class YSegmentedDisplay extends YFunction
{
     ...
     */
    static FindSegmentedDisplay(func, obj_yapi = YAPI)
    {
        /** @type {YSegmentedDisplay} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'SegmentedDisplay', func);
        if (obj == null) {
            obj = new YSegmentedDisplay(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'SegmentedDisplay',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YSegmentedDisplay} a YSegmentedDisplay object allowing you to drive the segmented displays.
     */
    static FindSegmentedDisplayInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YSegmentedDisplay} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'SegmentedDisplay', func);
        if (obj == null) {
            obj = new YSegmentedDisplay(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'SegmentedDisplay',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextSegmentedDisplay()
    {
        ...
        return YSegmentedDisplay.FindSegmentedDisplay(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstSegmentedDisplay(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('SegmentedDisplay');
        if(next_hwid == null) return null;
        return YSegmentedDisplay.FindSegmentedDisplay(next_hwid, obj_yapi);
    }
