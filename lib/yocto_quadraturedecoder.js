...
export class YQuadratureDecoder extends YSensor
{
     ...
     */
    static FindQuadratureDecoder(func, obj_yapi = YAPI)
    {
        /** @type {YQuadratureDecoder} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'QuadratureDecoder', func);
        if (obj == null) {
            obj = new YQuadratureDecoder(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'QuadratureDecoder',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YQuadratureDecoder} a YQuadratureDecoder object allowing you to drive the quadrature decoder.
     */
    static FindQuadratureDecoderInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YQuadratureDecoder} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'QuadratureDecoder', func);
        if (obj == null) {
            obj = new YQuadratureDecoder(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'QuadratureDecoder',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextQuadratureDecoder()
    {
        ...
        return YQuadratureDecoder.FindQuadratureDecoder(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstQuadratureDecoder(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('QuadratureDecoder');
        if(next_hwid == null) return null;
        return YQuadratureDecoder.FindQuadratureDecoder(next_hwid, obj_yapi);
    }
