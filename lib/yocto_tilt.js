...
export class YTilt extends YSensor
{
     ...
     */
    static FindTilt(func, obj_yapi = YAPI)
    {
        /** @type {YTilt} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Tilt', func);
        if (obj == null) {
            obj = new YTilt(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Tilt',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YTilt} a YTilt object allowing you to drive the tilt sensor.
     */
    static FindTiltInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YTilt} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Tilt', func);
        if (obj == null) {
            obj = new YTilt(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Tilt',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextTilt()
    {
        ...
        return YTilt.FindTilt(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstTilt(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Tilt');
        if(next_hwid == null) return null;
        return YTilt.FindTilt(next_hwid, obj_yapi);
    }
