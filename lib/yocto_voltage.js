...
export class YVoltage extends YSensor
{
     ...
     */
    static FindVoltage(func, obj_yapi = YAPI)
    {
        /** @type {YVoltage} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Voltage', func);
        if (obj == null) {
            obj = new YVoltage(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Voltage',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YVoltage} a YVoltage object allowing you to drive the voltage sensor.
     */
    static FindVoltageInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YVoltage} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Voltage', func);
        if (obj == null) {
            obj = new YVoltage(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Voltage',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextVoltage()
    {
        ...
        return YVoltage.FindVoltage(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstVoltage(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Voltage');
        if(next_hwid == null) return null;
        return YVoltage.FindVoltage(next_hwid, obj_yapi);
    }
