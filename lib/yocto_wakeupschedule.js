...
export class YWakeUpSchedule extends YFunction
{
     ...
     */
    static FindWakeUpSchedule(func, obj_yapi = YAPI)
    {
        /** @type {YWakeUpSchedule} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'WakeUpSchedule', func);
        if (obj == null) {
            obj = new YWakeUpSchedule(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'WakeUpSchedule',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YWakeUpSchedule} a YWakeUpSchedule object allowing you to drive the wake up schedule.
     */
    static FindWakeUpScheduleInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YWakeUpSchedule} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'WakeUpSchedule', func);
        if (obj == null) {
            obj = new YWakeUpSchedule(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'WakeUpSchedule',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextWakeUpSchedule()
    {
        ...
        return YWakeUpSchedule.FindWakeUpSchedule(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstWakeUpSchedule(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('WakeUpSchedule');
        if(next_hwid == null) return null;
        return YWakeUpSchedule.FindWakeUpSchedule(next_hwid, obj_yapi);
    }
