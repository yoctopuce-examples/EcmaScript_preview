...
export class YLatitude extends YSensor
{
     ...
     */
    static FindLatitude(func, obj_yapi = YAPI)
    {
        /** @type {YLatitude} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Latitude', func);
        if (obj == null) {
            obj = new YLatitude(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Latitude',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YLatitude} a YLatitude object allowing you to drive the latitude sensor.
     */
    static FindLatitudeInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YLatitude} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Latitude', func);
        if (obj == null) {
            obj = new YLatitude(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Latitude',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextLatitude()
    {
        ...
        return YLatitude.FindLatitude(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstLatitude(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Latitude');
        if(next_hwid == null) return null;
        return YLatitude.FindLatitude(next_hwid, obj_yapi);
    }
