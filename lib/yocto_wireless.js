...
export const Y_SECURITY_UNKNOWN              = 0;
export const Y_SECURITY_OPEN                 = 1;
export const Y_SECURITY_WEP                  = 2;
export const Y_SECURITY_WPA                  = 3;
export const Y_SECURITY_WPA2                 = 4;
export const Y_SECURITY_INVALID              = -1;
export const Y_LINKQUALITY_INVALID           = YAPI.INVALID_UINT;
export const Y_SSID_INVALID                  = YAPI.INVALID_STRING;
export const Y_CHANNEL_INVALID               = YAPI.INVALID_UINT;
export const Y_MESSAGE_INVALID               = YAPI.INVALID_STRING;
export const Y_WLANCONFIG_INVALID            = YAPI.INVALID_STRING;
...
export class YWireless extends YFunction
{
     ...
     */
    static FindWireless(func, obj_yapi = YAPI)
    {
        /** @type {YWireless} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Wireless', func);
        if (obj == null) {
            obj = new YWireless(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Wireless',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YWireless} a YWireless object allowing you to drive the wireless lan interface.
     */
    static FindWirelessInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YWireless} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Wireless', func);
        if (obj == null) {
            obj = new YWireless(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Wireless',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextWireless()
    {
        ...
        return YWireless.FindWireless(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstWireless(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Wireless');
        if(next_hwid == null) return null;
        return YWireless.FindWireless(next_hwid, obj_yapi);
    }
