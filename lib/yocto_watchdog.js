...
export class YWatchdog extends YFunction
{
     ...
     */
    static FindWatchdog(func, obj_yapi = YAPI)
    {
        /** @type {YWatchdog} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Watchdog', func);
        if (obj == null) {
            obj = new YWatchdog(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Watchdog',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YWatchdog} a YWatchdog object allowing you to drive the watchdog.
     */
    static FindWatchdogInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YWatchdog} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Watchdog', func);
        if (obj == null) {
            obj = new YWatchdog(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Watchdog',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextWatchdog()
    {
        ...
        return YWatchdog.FindWatchdog(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstWatchdog(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Watchdog');
        if(next_hwid == null) return null;
        return YWatchdog.FindWatchdog(next_hwid, obj_yapi);
    }
