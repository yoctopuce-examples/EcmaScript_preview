...
export class YAccelerometer extends YSensor
{
     ...
     */
    static FindAccelerometer(func, obj_yapi = YAPI)
    {
        /** @type {YAccelerometer} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Accelerometer', func);
        if (obj == null) {
            obj = new YAccelerometer(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Accelerometer',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YAccelerometer} a YAccelerometer object allowing you to drive the accelerometer.
     */
    static FindAccelerometerInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YAccelerometer} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Accelerometer', func);
        if (obj == null) {
            obj = new YAccelerometer(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Accelerometer',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextAccelerometer()
    {
        ...
        return YAccelerometer.FindAccelerometer(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstAccelerometer(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Accelerometer');
        if(next_hwid == null) return null;
        return YAccelerometer.FindAccelerometer(next_hwid, obj_yapi);
    }
