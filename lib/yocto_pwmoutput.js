...
export class YPwmOutput extends YFunction
{
     ...
     */
    static FindPwmOutput(func, obj_yapi = YAPI)
    {
        /** @type {YPwmOutput} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'PwmOutput', func);
        if (obj == null) {
            obj = new YPwmOutput(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'PwmOutput',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YPwmOutput} a YPwmOutput object allowing you to drive the PWM.
     */
    static FindPwmOutputInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YPwmOutput} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'PwmOutput', func);
        if (obj == null) {
            obj = new YPwmOutput(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'PwmOutput',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextPwmOutput()
    {
        ...
        return YPwmOutput.FindPwmOutput(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstPwmOutput(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('PwmOutput');
        if(next_hwid == null) return null;
        return YPwmOutput.FindPwmOutput(next_hwid, obj_yapi);
    }
