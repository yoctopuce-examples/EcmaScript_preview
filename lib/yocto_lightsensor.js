...
export class YLightSensor extends YSensor
{
     ...
     */
    static FindLightSensor(func, obj_yapi = YAPI)
    {
        /** @type {YLightSensor} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'LightSensor', func);
        if (obj == null) {
            obj = new YLightSensor(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'LightSensor',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YLightSensor} a YLightSensor object allowing you to drive the light sensor.
     */
    static FindLightSensorInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YLightSensor} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'LightSensor', func);
        if (obj == null) {
            obj = new YLightSensor(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'LightSensor',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextLightSensor()
    {
        ...
        return YLightSensor.FindLightSensor(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstLightSensor(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('LightSensor');
        if(next_hwid == null) return null;
        return YLightSensor.FindLightSensor(next_hwid, obj_yapi);
    }
