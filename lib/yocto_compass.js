...
export class YCompass extends YSensor
{
     ...
     */
    static FindCompass(func, obj_yapi = YAPI)
    {
        /** @type {YCompass} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, 'Compass', func);
        if (obj == null) {
            obj = new YCompass(obj_yapi, func);
            YFunction._AddToCache(obj_yapi, 'Compass',  func, obj);
        }
        return obj;
    }
     ...
     * @return {YCompass} a YCompass object allowing you to drive the compass.
     */
    static FindCompassInContext(yctx,func, obj_yapi = YAPI)
    {
        /** @type {YCompass} **/
        let obj;
        obj = YFunction._FindFromCache(obj_yapi, yctx,  'Compass', func);
        if (obj == null) {
            obj = new YCompass(obj_yapi, yctx, func);
            YFunction._AddToCache(obj_yapi, 'Compass',  func, obj);
        }
        return obj;
    }
    ...
    /**/ nextCompass()
    {
        ...
        return YCompass.FindCompass(next_hwid, this._yapi);
    }
     ...
     *         if there are none.
     */
    static FirstCompass(obj_yapi = YAPI)
    {
        /** @type {string} **/
        let next_hwid = obj_yapi.imm_getFirstHardwareId('Compass');
        if(next_hwid == null) return null;
        return YCompass.FindCompass(next_hwid, obj_yapi);
    }
